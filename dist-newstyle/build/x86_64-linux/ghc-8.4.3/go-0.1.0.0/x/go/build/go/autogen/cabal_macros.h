...
/* package go-0.1.0.0 */
#ifndef VERSION_go
#define VERSION_go "0.1.0.0"
#endif /* VERSION_go */
#ifndef MIN_VERSION_go
#define MIN_VERSION_go(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_go */
...
#define CURRENT_COMPONENT_ID "go-0.1.0.0-inplace-go"
